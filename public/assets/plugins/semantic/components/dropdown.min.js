                    ...
                    (m = {
                        ...
                        observeChanges: function () {
                            "MutationObserver" in Y &&
                                ((s = new MutationObserver(
                                    m.event.select.mutation
                                )),
                                (r = new MutationObserver(
                                    m.event.menu.mutation
                                )),
                            ...
                            userLabels: function (e) {
                                ...
                                t &&
                                    ...
                                    X.each(t, function (e, t) {
                                        m.verbose("Adding custom user value"),
                                            m.add.label(t, t);
                                    }));
                            },
                            menu: function () {
                        ...
                        setup: {
                            api: function () {
                                ...
                                m.verbose("First request, initializing API"),
                                    S.api(e);
                            },
                            layout: function () {
                                S.is("select") &&
                                    ...
                                    0 < L.parent(w.dropdown).length
                                        ...
                                        : (m.debug(
                                          ...
                                          L.hasClass(g.multiple) &&
                                              !1 === L.prop("multiple") &&
                                              (m.error(v.missingMultiple),
                                              L.prop("multiple", !0)),
                                          L.is("[multiple]") &&
                                              m.set.multiple(),
                                          L.prop("disabled") &&
                                              (m.debug("Disabling dropdown"),
                                    ...
                                    m.is.searchSelection()
                                        ? (S.on(
                                              ...
                                              .on(
                                                  "mousedown" + x,
                                                  w.menu,
                                                  m.event.menu.mousedown
                                              )
                                              .on(
                                                  "mouseup" + x,
                                                  w.menu,
                                                  m.event.menu.mouseup
                                              )
                                              .on(
                                                  "click" + x,
                                                  w.icon,
                                ...
                                R.each(function () {
                                    ...
                                    if (
                                        ...
                                        if (
                                            -1 !==
                                            (e = String(
                                                m.get.choiceText(n, !1)
                                            )).search(o)
                                        )
                                            return a.push(this), !0;
                                        if (
                                            "exact" === h.fullTextSearch &&
                                            m.exactSearch(i, e)
                                        )
                                            return a.push(this), !0;
                                        if (
                        ...
                        filterActive: function () {
                            h.useLabels &&
                                R.filter("." + g.active).addClass(g.filtered);
                        },
                        ...
                        event: {
                            ...
                            input: function (e) {
                                (m.is.multiple() || m.is.searchSelection()) &&
                                    m.set.filtered(),
                            ...
                            test: {
                                toggle: function (e) {
                                    ...
                                    m.is.bubbledLabelClick(e) ||
                                        ...
                                        (m.determine.eventOnElement(e, t) &&
                                            e.preventDefault());
                                },
                                touch: function (e) {
                            ...
                            menu: {
                                mutation: function (e) {
                                    var t = e[0],
                                        ...
                                        o =
                                            a.is(w.addition) ||
                                            0 < a.closest(w.addition).length,
                                        s =
                                            a.is(w.message) ||
                                            0 < a.closest(w.message).length;
                                    o || s
                                        ? (m.debug(
                                              "Updating item selector cache"
                                          ),
                                          m.refreshItems())
                                        : (m.debug(
                            ...
                            item: {
                                ...
                                click: function (e, t) {
                                    var n = X(this),
                                        ...
                                        l = 0 < a.find(i).length;
                                    m.has.menuSearch() &&
                                        X(G.activeElement).blur(),
                                        l ||
                                            (r && !h.allowCategorySelection) ||
                                            (m.is.searchSelection() &&
                                                (h.allowAdditions &&
                                                    m.remove.userAddition(),
                                                m.remove.searchTerm(),
                                                m.is.focusedOnSearch() ||
                                                    1 == t ||
                                                    m.focusSearch(!0)),
                        ...
                        get: {
                            ...
                            caretPosition: function () {
                                ...
                                return "selectionStart" in n
                                    ...
                                    : G.selection
                                    ? (n.focus(),
                                      (t = (e = G.selection.createRange()).text
                                          .length),
                            ...
                            selectedItem: function () {
                                var e = R.not(w.unselectable).filter(
                                    "." + g.selected
                                );
                        ...
                        restore: {
                            defaults: function () {
                                m.clear(),
                                    m.restore.defaultText(),
                                    m.restore.defaultValue();
                            },
                            defaultText: function () {
                                ...
                                e === m.get.placeholderText
                                    ...
                                    : (m.debug("Restoring default text", e),
                                      m.set.text(e));
                            },
                            placeholderText: function () {
                            ...
                            labels: function () {
                                h.allowAdditions &&
                                    (h.useLabels ||
                                        (m.error(v.labels), (h.useLabels = !0)),
                        ...
                        set: {
                            ...
                            scrollPosition: function (e, t) {
                                var n, i, a, o, s, r;
                                (n = (e = e || m.get.selectedItem()).closest(
                                    w.menu
                                )),
                                    (i = e && 0 < e.length),
                                    (t = t !== J && t),
                        ...
                        remove: {
                            ...
                            value: function (e, t, n) {
                                ...
                                m.has.selectInput()
                                    ...
                                    : (m.verbose(
                                      ...
                                      (i = (i = m.remove.arrayValue(e, a)).join(
                                          h.delimiter
                                      ))),
                                    !1 === h.fireOnInit && m.is.initialLoad()
                                        ? m.verbose(
                            ...
                            activeLabels: function (e) {
                                (e =
                                    e ||
                                    S.find(w.label).filter("." + g.active)),
                                    m.verbose(
                        ...
                        has: {
                            menuSearch: function () {
                                return (
                                    m.has.search() && 0 < T.closest(q).length
                                );
                            },
                            search: function () {
                                return 0 < T.length;
                            ...
                            maxSelections: function () {
                                return (
                                    h.maxSelections &&
                                    m.get.selectionCount() >= h.maxSelections
                                );
                            },
                            allResultsFiltered: function () {
                                var e = R.not(w.addition);
                                return (
                                    e.filter(w.unselectable).length === e.length
                                );
                            },
                        ...
                        is: {
                            ...
                            visible: function (e) {
                                return e
                                    ? e.hasClass(g.visible)
                                    : q.hasClass(g.visible);
                            },
