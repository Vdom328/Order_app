            ...
            <ul class="list-inline mb-0">
                ...
                <li class="list-inline-item">
                    <a class="hidden-xs hidden-sm waves-effect tooltip-primary" href="javascript:void(0)"
                        id="collapsed-sidebar-toggle-button" data-toggle="tooltip" data-trigger="hover" title=""
                        data-original-title="Toggle Sidebar">
                        <svg class="adata-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24" />
        ...
        <div class="header-right">
            <ul class="list-inline justify-content-end mb-0 d-flex align-items-center">
                ...
                <li class="list-inline-item dropdown hidden-xs">
                    <a class="dropdown-icon waves-effect" href="" role="button" data-toggle="dropdown"
                        ...
                        <div class="row no-gutters header-service">
                            <div class="col-md-6 bd-r bd-b">
                                <a href="" class="tx-center d-block waves-effect waves-light">
                                    <img src="../../assets/images/icon/bag.png" class="img-fluid wd-50"
                                        alt="">
                            ...
                            <div class="col-md-6 bd-b">
                                <a href="" class="tx-center d-block waves-effect waves-light">
                                    <img src="../../assets/images/icon/bill.png" class="img-fluid wd-50"
                                        alt="">
                            ...
                            <div class="col-md-6 bd-r bd-b">
                                <a href="" class="tx-center d-block waves-effect waves-light">
                                    <img src="../../assets/images/icon/bill-reciept.png" class="img-fluid wd-50"
                                        alt="">
                                    <h2 class="tx-15 mg-t-10 mb-0">Billing</h2>
                            ...
                            <div class="col-md-6 bd-b">
                                <a href="" class="tx-center d-block waves-effect waves-light">
                                    <img src="../../assets/images/icon/finance.png" class="img-fluid wd-50"
                                        alt="">
                            ...
                            <div class="col-md-6 bd-r bd-b">
                                <a href="" class="tx-center d-block waves-effect waves-light">
                                    <img src="../../assets/images/icon/offer.png" class="img-fluid wd-50"
                                        alt="">
                            ...
                            <div class="col-md-6 bd-b">
                                <a href="" class="tx-center d-block waves-effect waves-light">
                                    <img src="../../assets/images/icon/shipping.png" class="img-fluid wd-50"
                                        alt="">
                ...
                <li class="list-inline-item dropdown hidden-xs">
                    ...
                    <ul class="dropdown-menu languages-dropdown">
                        <li>
                            <a href="" class="d-flex align-items-center" data-lang="en"><i
                                    class="flag-icon flag-icon-us mr-2"></i><span>English-US</span></a>
                        </li>
                        <li>
                            <a href="" class="d-flex align-items-center" data-lang="es"><i
                                    class="flag-icon flag-icon-es mr-2"></i><span>Spanish</span></a>
                        </li>
                        <li>
                            <a href="" class="d-flex align-items-center" data-lang="fr"><i
                                    class="flag-icon flag-icon-fr mr-2"></i><span>French</span></a>
                        </li>
                        <li>
                            <a href="" class="d-flex align-items-center" data-lang="gr"><i
                                    class="flag-icon flag-icon-de mr-2"></i><span>German</span></a>
                        </li>
                        <li>
                            <a href="" class="d-flex align-items-center" data-lang="ru"><i
                        ...
                        <div class="top-notifications-area">
                            ...
                            <div class="notifications-box" id="notificationsBox">
                                ...
                                <a class="dropdown-item list-group-item" href="">
                                    <div class="d-flex justify-content-between">
                                        <div
                                            class="wd-40 ht-40 mg-r-10 d-flex align-items-center justify-content-center rounded card-icon-warning">
                                ...
                                <a class="dropdown-item list-group-item" href="">
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="tx-12 d-block text-truncate">New payment has been
                                            failed</div>
                                        <span class="tx-11 tx-gray-400">Mar 15, 12:32pm</span>
                                    </div>
                                </a>
                                <a class="dropdown-item list-group-item" href="">
                                    <div class="d-flex justify-content-between">
                                        <div
                                            class="wd-40 ht-40 mg-r-10 d-flex align-items-center justify-content-center rounded card-icon-primary">
                                            <i data-feather="info" class="wd-20"></i>
                                        </div>
                                    </div>
                                    <div class="overflow-hidden">
                                        <h3 class="tx-15 mg-b-5">Document available</h3>
                                        <div class="tx-12 d-block text-truncate">New order has been
                                            received</div>
                                        <span class="tx-11 tx-gray-400">Mar 15, 12:32pm</span>
                                    </div>
                                </a>
                                ...
                                <a class="dropdown-item list-group-item" href="">
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="tx-12 d-block text-truncate">New user feedback
                                            received</div>
                                        <span class="tx-11 tx-gray-400">Mar 15, 12:32pm</span>
                                    </div>
                                </a>
                            ...
                            <div class="notifications-footer d-flex justify-content-between align-items-center">
                                ...
                                <a href="" class="tooltip-primary" data-toggle="tooltip"
                                    ...
                                    data-original-title="Notifications Settings"><i data-feather="settings"
                        ...
                        <div class="top-message-area">
                            ...
                            <div class="message-box" id="messageBox">
                                ...
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                    <div class="pd-r-10 d-flex align-items-center justify-content-center">
                                        <span class="avatar avatar-online">
                                            <img src="../../assets/images/users-face/1.png" class="img-fluid"
                                                alt="">
                                            <i></i>
                                        </span>
                                    </div>
                                ...
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                    <div class="pd-r-10 d-flex align-items-center justify-content-center">
                                        <span class="avatar avatar-online">
                                            <img src="../../assets/images/users-face/2.png" class="img-fluid"
                                                alt="">
                                            <i></i>
                                        </span>
                                    </div>
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="tx-12 text-truncate">Richards Caleb, just created a
                                            new blog post</div>
                                    </div>
                                </a>
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                    <div class="pd-r-10 d-flex align-items-center justify-content-center">
                                        <span class="avatar avatar-busy">
                                            <img src="../../assets/images/users-face/3.png" class="img-fluid"
                                                alt="">
                                            <i></i>
                                        </span>
                                    </div>
                                ...
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                    <div class="pd-r-10 d-flex align-items-center justify-content-center">
                                        <span class="avatar avatar-busy">
                                            <img src="../../assets/images/users-face/4.png" class="img-fluid"
                                                alt="">
                                            <i></i>
                                        </span>
                                    </div>
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="tx-12 text-truncate">Adrian Monino, added new comment
                                            on your photo</div>
                                    </div>
                                </a>
                                ...
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                    <div class="pd-r-10 d-flex align-items-center justify-content-center">
                                        <span class="avatar avatar-offline">
                                            <img src="../../assets/images/users-face/5.png" class="img-fluid"
                                                alt="">
                                            <i></i>
                                        </span>
                                    </div>
                                ...
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                    <div class="pd-r-10 d-flex align-items-center justify-content-center">
                                        <span class="avatar avatar-offline">
                                            <img src="../../assets/images/users-face/6.png" class="img-fluid"
                                                alt="">
                                            <i></i>
                                        </span>
                                    </div>
                            ...
                            <div class="top-message-footer d-flex justify-content-between align-items-center">
                                ...
                                <a href="" class="tooltip-primary" data-toggle="tooltip"
                                    data-placement="left" title="" data-original-title="Messages Settings"><i
                                        data-feather="settings" class="wd-16 ht-16"></i></a>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li class="list-inline-item dropdown ml-2">
                    <a href="" role="button" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        <img src="../../assets/images/users-face/1.png" class="img-fluid wd-30 ht-30 rounded-circle"
                            alt="">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-profile">
                        <div class="user-profile-area">
                            ...
                            <a href="" class="dropdown-item d-flex align-items-center"><span
                                    data-feather="message-square" class="wd-16 ht-16 mr-2"></span>Messages</a>
                            <div class="dropdown-divider"></div>
                            <a href="" class="dropdown-item d-flex align-items-center"><span
                                    data-feather="settings" class="wd-16 ht-16 mr-2"></span>Settings</a>
                            <a href="" class="dropdown-item d-flex align-items-center"><span
                                    data-feather="activity" class="wd-16 ht-16 mr-2"></span>Activity</a>
                            <a href="" class="dropdown-item d-flex align-items-center"><span
                                    data-feather="download" class="wd-16 ht-16 mr-2"></span>Download</a>
                            <div class="dropdown-divider"></div>
                            <a href="" class="dropdown-item d-flex align-items-center"><span
                                    data-feather="layout" class="wd-16 ht-16 mr-2"></span>Forum</a>
                            <a href="" class="dropdown-item d-flex align-items-center"><span
    ...
    <div class="pd-y-10 pd-x-30 d-flex justify-content-between align-items-center header-bottom">
        <div class="d-flex align-items-center">
            <h2 class="d-flex align-items-center tx-16 mb-0 pd-r-15 mr-2 bd-r "><i data-feather="airplay"
                    class="wd-20 mr-2"></i>@yield('title')</h2>
        </div>
    </div>
</div>
<!--/ Page Header End -->
